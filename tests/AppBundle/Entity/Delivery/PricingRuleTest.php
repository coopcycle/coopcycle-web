...
class PricingRuleTest extends TestCase
{
    ...
    public function testEvaluatePrice()
    {
        ...
        $this->assertEquals(2250, $rule->evaluatePrice(Delivery::toExpressionLanguageValues($delivery)));
        ...
        // 7€ + 2,5€ per package
        $this->assertEquals(950, $rule->evaluatePrice(Delivery::toExpressionLanguageValues($delivery)));
    }
}
