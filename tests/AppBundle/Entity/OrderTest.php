...
class OrderTest extends TestCase
{
    ...
    public function testDistanceValidation()
    {
        ...
        $this->assertEquals($this->violationsToArray($errors)['delivery.distance'][0], 'This value should not be blank.');
    ...
    public function testDateValidation()
    {
        ...
        $errors = $this->validator->validate($order, null, ['order']);
        $this->assertEquals('Restaurant is closed at 2017-09-03 12:30:00', $this->violationsToArray($errors)['delivery.date'][0]);

        // Delivery is too soon
        Carbon::setTestNow(Carbon::create(2017, 9, 3, 12, 25));
        $errors = $this->validator->validate($order, null, ['order']);
        $this->assertContains('Delivery date 2017-09-03 12:30:00 is invalid', $this->violationsToArray($errors)['delivery.date']);
    }
}
