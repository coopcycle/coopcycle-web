...
#[ApiResource(shortName: 'User', itemOperations: ['get' => ['method' => 'GET', 'access_control' => "is_granted('ROLE_ADMIN') or user == object"], 'put' => ['method' => 'PUT', 'access_control' => "is_granted('ROLE_ADMIN') or user == object", 'denormalization_context' => ['groups' => ['user_update']]]], collectionOperations: ['get' => ['method' => 'GET', 'access_control' => "is_granted('ROLE_ADMIN')", 'pagination_enabled' => false], 'get_stripe_payment_methods' => ['method' => 'GET', 'path' => '/me/stripe-payment-methods', 'controller' => MyStripePaymentMethods::class, 'output' => StripePaymentMethodsOutput::class, 'normalization_context' => ['api_sub_level' => true]]], attributes: ['normalization_context' => ['groups' => ['user', 'order']]])]
