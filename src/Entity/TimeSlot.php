...
#[ApiResource(operations: [new Get(), new Delete(security: 'is_granted(\'ROLE_ADMIN\')'), new Get(uriTemplate: '/time_slots/{id}/choices', controller: StoreOpeningHours::class, normalizationContext: ['groups' => ['time_slot_choices'], 'api_sub_level' => true], security: 'is_granted(\'edit\', object)'), new GetCollection(security: 'is_granted(\'ROLE_ADMIN\')'), new GetCollection(uriTemplate: '/time_slots/choices', controller: Choices::class, status: 200, read: false, write: false, normalizationContext: ['groups' => ['time_slot_choices'], 'api_sub_level' => true], security: 'is_granted(\'ROLE_OAUTH2_DELIVERIES\')', openapiContext: ['summary' => 'Retrieves choices for time slot'])], normalizationContext: ['groups' => ['time_slot']], paginationClientEnabled: true)]
class TimeSlot
{
    use Timestampable;
