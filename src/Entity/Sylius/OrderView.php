...
class OrderView
{
    ...
    public static function create(Connection $conn)
    {
        ...
        $selects[] = 'CASE WHEN v.hub_id IS NOT NULL THEN \'hub\' ELSE \'restaurant\' END AS vendor_type';
        ...
        $parts[] = 'INNER JOIN vendor v ON (o.vendor_id = v.id)';
        ...
        $parts[] = 'GROUP BY o.id, o.number, v.id, h.id, COALESCE(v.restaurant_id, hr.restaurant_id)';
