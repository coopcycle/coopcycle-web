...
#[ApiResource(
    operations: [
        ...
        new Put(controller: Edit::class, security: 'is_granted(\'edit\', object)', denormalizationContext: ['groups' => ['delivery_create']]),
        new Put(uriTemplate: '/deliveries/{id}/pick', controller: Pick::class, security: 'is_granted(\'edit\', object)', openapiContext: ['summary' => 'Marks a Delivery as picked']),
        new Put(uriTemplate: '/deliveries/{id}/drop', controller: Drop::class, security: 'is_granted(\'edit\', object)', openapiContext: ['summary' => 'Marks a Delivery as dropped']),
        new Delete(controller: Cancel::class, write: false, security: 'is_granted(\'edit\', object)', openapiContext: ['summary' => 'Cancels a Delivery'], name: 'cancel'),
        new Post(denormalizationContext: ['groups' => ['delivery_create']], controller: Create::class, openapiContext: ['parameters' => [['name' => 'delivery', 'in' => 'body', 'schema' => ['type' => 'object', 'required' => ['dropoff'], 'properties' => ['dropoff' => ['$ref' => '#/definitions/Task-task_create'], 'pickup' => ['$ref' => '#/definitions/Task-task_create']]], 'style' => 'form']]], inputFormats: ['jsonld' => ['application/ld+json']], securityPostDenormalize: 'is_granted(\'create\', object)'),
        new Post(uriTemplate: '/deliveries/assert', write: false, status: 200, validationContext: ['groups' => ['Default', 'delivery_check']], denormalizationContext: ['groups' => ['delivery_create']], securityPostDenormalize: 'is_granted(\'create\', object)', openapiContext: ['summary' => 'Asserts a Delivery is feasible', 'parameters' => [['name' => 'delivery', 'in' => 'body', 'schema' => ['type' => 'object', 'required' => ['dropoff'], 'properties' => ['dropoff' => ['$ref' => '#/definitions/Task-task_create'], 'pickup' => ['$ref' => '#/definitions/Task-task_create']]], 'style' => 'form']]]),
        new Post(
