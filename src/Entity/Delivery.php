...
#[ApiResource(
    operations: [
        ...
        new Put(controller: EditDelivery::class, security: 'is_granted(\'edit\', object)', denormalizationContext: ['groups' => ['delivery_create']]),
        new Put(uriTemplate: '/deliveries/{id}/pick', controller: PickDelivery::class, security: 'is_granted(\'edit\', object)', openapiContext: ['summary' => 'Marks a Delivery as picked']),
        new Put(uriTemplate: '/deliveries/{id}/drop', controller: DropDelivery::class, security: 'is_granted(\'edit\', object)', openapiContext: ['summary' => 'Marks a Delivery as dropped']),
        ...
        new Post(denormalizationContext: ['groups' => ['delivery_create']], controller: CreateDelivery::class, openapiContext: ['parameters' => [['name' => 'delivery', 'in' => 'body', 'schema' => ['type' => 'object', 'required' => ['dropoff'], 'properties' => ['dropoff' => ['$ref' => '#/definitions/Task-task_create'], 'pickup' => ['$ref' => '#/definitions/Task-task_create']]], 'style' => 'form']]], inputFormats: ['jsonld' => ['application/ld+json']], securityPostDenormalize: 'is_granted(\'create\', object)'),
