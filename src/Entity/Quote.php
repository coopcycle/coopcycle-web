 ...
 */
class Quote extends TaskCollection implements TaskCollectionInterface, PackagesAwareInterface
{
    ...
    public static function toVroomShipment(Quote $delivery): VroomShipment
    {
