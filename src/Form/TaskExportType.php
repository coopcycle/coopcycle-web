        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event) {
                ...
                'body' => json_encode([
                  'query' => [
                    ...
                    'dimensions' => [
                        ...
                        "TasksExportUnified.orderStripeFeeTotal",
            ...
            foreach ($resultSet['data'] as $resultObject) {
                ...
                $records[] = array_combine(self::$columns, [
                    ...
                    ($resultObject['TasksExportUnified.orderTotal'] - $resultObject['TasksExportUnified.orderFeeTotal'] - $resultObject['TasksExportUnified.orderStripeFeeTotal']),
