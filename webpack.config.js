...
Encore
  ...
  .addEntry('delivery-forms-list', './js/app/admin/delivery-forms.js')
  ...
  .addEntry('package-sets-list', './js/app/admin/packageSets.js')
  .addEntry('pricings', './js/app/admin/pricingRuleSets.js')
