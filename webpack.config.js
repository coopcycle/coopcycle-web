...
Encore
  ...
  .addEntry('email-editor', './js/app/admin/email-editor/index.js')
  ...
  .addEntry('admin-shift-planning', './js/app/admin/shift-planning/entrypoint.tsx')
  ...
  .addEntry('profile-shifts', './js/app/profile/shifts/entrypoint.tsx')
