...
final class Version20220819141352 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE woopit_integration (id SERIAL NOT NULL, store_id INT DEFAULT NULL, zone_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, max_weight DOUBLE PRECISION DEFAULT NULL, max_length DOUBLE PRECISION DEFAULT NULL, max_height DOUBLE PRECISION DEFAULT NULL, max_width DOUBLE PRECISION DEFAULT NULL, woopit_store_id VARCHAR(255) NOT NULL, delivery_zone_expression VARCHAR(255) DEFAULT NULL, product_types JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
