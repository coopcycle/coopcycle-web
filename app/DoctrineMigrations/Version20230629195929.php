...
final class Version20230629195929 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE sylius_order_loopeat_credentials (id SERIAL NOT NULL, order_id INT NOT NULL, loopeat_access_token TEXT DEFAULT NULL, loopeat_refresh_token TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
