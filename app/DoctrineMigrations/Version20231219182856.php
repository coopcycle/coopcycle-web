...
final class Version20231219182856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE business_restaurant_group_restaurant ADD CONSTRAINT FK_35D9C1C7C4EC76B FOREIGN KEY (business_restaurant_group_id) REFERENCES business_restaurant_group (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE business_restaurant_group_restaurant ADD CONSTRAINT FK_35D9C1C7B1E7706E FOREIGN KEY (restaurant_id) REFERENCES restaurant (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE business_restaurant_group_restaurant DROP CONSTRAINT FK_35D9C1C7C4EC76B');
        ...
        $this->addSql('DROP TABLE business_restaurant_group_restaurant');
