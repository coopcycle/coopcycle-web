 ...
 */
final class Version20231003183816 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE business_account (id SERIAL NOT NULL, invitation_code VARCHAR(180) DEFAULT NULL, address_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2005EDE9BA14FCCC ON business_account (invitation_code)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2005EDE9F5B7AF75 ON business_account (address_id)');
        $this->addSql('ALTER TABLE business_account ADD CONSTRAINT FK_2005EDE9BA14FCCC FOREIGN KEY (invitation_code) REFERENCES invitation (code) NOT DEFERRABLE INITIALLY IMMEDIATE');
