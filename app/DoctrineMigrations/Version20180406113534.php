 ...
 */
class Version20180406113534 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE address ALTER geo SET NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE address ALTER geo DROP NOT NULL');
