...
| `APP_URL`            | The public HTTPS URL of this gateway, **without** a trailing slash. Example: `https://connect.coopcycle.org` |
...
SHOPIFY_API_SECRET=...
GATEWAY_SECRET=...
APP_URL=https://connect.coopcycle.org
...
`connect.coopcycle.org` to it — TLS is terminated by nginx, not Caddy. The gateway
