context('Delivery (role: dispatcher)', () => {
  ...
  it('create delivery order with cash payment', function () {
    ...
    cy.get('[data-testid="cash-on-delivery-checkbox"]').check();
    ...
    cy.get('[data-testid="payment-0:method-name"]').contains(
      'Cash on delivery',
    );
