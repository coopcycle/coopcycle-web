describe(
  'guest checkout: Failed; restaurant is closed while the customer is on the address page',
  () => {
        ...
        context(
          ...
          ` (${ customerType })`, () => {
            it('suggest to choose a new time range (Timing modal)' +
              ...
              cy.clickRestaurant('Crazy Hamburger',
              ...
              cy.searchAddressUsingAddressModal(
                '.ReactModal__Content--enter-address', '91 rue de rivoli paris',
              ...
              cy.get('[data-testid="order.time"]:visible')
                .invoke('text')
