 ...
 * see SaveAsTemplateButton for how templates get created. Also lets a
 * dispatcher delete templates they no longer need.
 */
export default function LoadTemplateButton({ weekStart }: Props) {
