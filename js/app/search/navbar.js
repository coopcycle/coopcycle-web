...
function ComboBox({ t }) {
  ...
  return (
    <>
      <div className={cx('relative w-full lg:w-auto', /*isLoading && 'has-loader-loading'*/)}>
        {/* FIXME
        The "label" HTML tag style is overriden by Bootstrap in AddressAutosuggest
        Use a span atm */}
        <span className="input input-bordered bg-base-100 text-base-content w-full lg:w-auto">
