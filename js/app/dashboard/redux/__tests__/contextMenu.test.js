import { START_TASKS_MULTI, COMPLETE_TASKS_MULTI, ADD_TO_GROUP, ASSIGN_MULTI, ASSIGN_WITH_LINKED_TASKS_MULTI, CANCEL_MULTI, CREATE_DELIVERY, CREATE_GROUP, CREATE_TOUR, MOVE_TO_BOTTOM, MOVE_TO_NEXT_DAY_MULTI, MOVE_TO_NEXT_WORKING_DAY_MULTI, MOVE_TO_TOP, REMOVE_FROM_GROUP, SEND_TO_WAREHOUSE, UNASSIGN_MULTI, UNASSIGN_SINGLE, RESCHEDULE, REPORT_INCIDENT, TAG_MULTI, getAvailableActionsForTasks } from '../../components/context-menus/TasksContextMenu'
...
describe('updateTask', () => {
    it('should return actions for a single unassigned task', () => {
        ...
        expect(actions).toStrictEqual([ASSIGN_MULTI, ASSIGN_WITH_LINKED_TASKS_MULTI, CREATE_GROUP, CREATE_TOUR, CANCEL_MULTI, START_TASKS_MULTI, COMPLETE_TASKS_MULTI, RESCHEDULE, REPORT_INCIDENT, MOVE_TO_NEXT_DAY_MULTI, MOVE_TO_NEXT_WORKING_DAY_MULTI, ADD_TO_GROUP])
    })
    ...
    it('should return actions for one unassigned pickup and one unassigned dropoff into a group', () => {
        ...
        expect(actions).toStrictEqual([START_TASKS_MULTI, COMPLETE_TASKS_MULTI, ASSIGN_MULTI, ASSIGN_WITH_LINKED_TASKS_MULTI, CANCEL_MULTI, CREATE_GROUP, CREATE_TOUR, TAG_MULTI, REMOVE_FROM_GROUP, CREATE_DELIVERY, SEND_TO_WAREHOUSE, MOVE_TO_NEXT_DAY_MULTI, MOVE_TO_NEXT_WORKING_DAY_MULTI])
    ...
    it('should return actions for a single assigned task', () => {
        ...
        expect(actions).toStrictEqual([UNASSIGN_SINGLE, MOVE_TO_TOP, MOVE_TO_BOTTOM, CANCEL_MULTI, START_TASKS_MULTI, COMPLETE_TASKS_MULTI, RESCHEDULE, REPORT_INCIDENT])
    })
    ...
    it('should return actions for several assigned tasks', () => {
        ...
        expect(actions).toStrictEqual([START_TASKS_MULTI, COMPLETE_TASKS_MULTI, UNASSIGN_MULTI])
    })
