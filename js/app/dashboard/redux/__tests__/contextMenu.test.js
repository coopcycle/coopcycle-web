import { START_TASKS_MULTI, ADD_TO_GROUP, ASSIGN_MULTI, ASSIGN_WITH_LINKED_TASKS_MULTI, CANCEL_MULTI, CREATE_DELIVERY, CREATE_GROUP, CREATE_TOUR, MOVE_TO_BOTTOM, MOVE_TO_NEXT_DAY_MULTI, MOVE_TO_NEXT_WORKING_DAY_MULTI, MOVE_TO_TOP, REMOVE_FROM_GROUP, UNASSIGN_MULTI, UNASSIGN_SINGLE, RESCHEDULE, REPORT_INCIDENT, TAG_MULTI, getAvailableActionsForTasks } from '../../components/context-menus/TasksContextMenu'
...
describe('updateTask', () => {
    ...
    it('should return actions for one unassigned pickup and one unassigned dropoff into a group', () => {
        ...
        expect(actions).toStrictEqual([START_TASKS_MULTI, ASSIGN_MULTI, ASSIGN_WITH_LINKED_TASKS_MULTI, CANCEL_MULTI, CREATE_GROUP, CREATE_TOUR, TAG_MULTI, REMOVE_FROM_GROUP, CREATE_DELIVERY, MOVE_TO_NEXT_DAY_MULTI, MOVE_TO_NEXT_WORKING_DAY_MULTI])
