    ...
    <div>
      <div className="border-bottom pb-3 mb-3">
        ...
        >
          ...
          <Radio style={radioStyle} value="GROUP_MODE_PICKUP_ASC">
            {t('ADMIN_DASHBOARD_VIEW_MODE_PICKUP_ASC')}
          </Radio>
          <Radio style={radioStyle} value="GROUP_MODE_PICKUP_DESC">
            {t('ADMIN_DASHBOARD_VIEW_MODE_PICKUP_DESC')}
          </Radio>
      ...
      <Checkbox
        onChange={e => showRecurrenceRules(e.target.checked)}
